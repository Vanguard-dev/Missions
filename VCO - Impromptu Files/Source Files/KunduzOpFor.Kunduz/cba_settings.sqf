...
force force ace_repair_engineerSetting_wheel = 1;
...
Achilles_var_FGN_fractionAAF = true;
Achilles_var_FGN_fractionFIA = true;
...
force force TFAR_setting_defaultFrequencies_sr_east = "51";
force force TFAR_setting_defaultFrequencies_sr_independent = "";
force force TFAR_setting_defaultFrequencies_sr_west = "51";
